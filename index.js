...
const client = new MongoClient(
  "mongodb+srv://admin:admin@cluster0.tlmzl.mongodb.net/my-db?retryWrites=true&w=majority"
);
  ...
  app.get("/api/table", async (req, res) => {
    ...
    if (filter) {
      ...
      if (column === "name") {
        query.name = {
          $regex:
            condition === "match" ? normalizedValue : `^${normalizedValue}$`,
          $options: "i",
        };
      } else {
        query[column] =
